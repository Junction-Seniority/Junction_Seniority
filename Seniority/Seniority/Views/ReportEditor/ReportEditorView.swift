...
struct ReportEditorView: View {
    ...
    private func buildPrompt() -> String {
        ...
        7. **일반 마크다운 형식**: 마크다운 형식은 맞지만, 다른 마크다운 기호(#, -, ``` 등)를 사용하지 마세요. 오직 Bold처리를 위한 **만 사용하되, 실제 중요하다고 판단되는 곳에만 적재적소에 반영하세요.
        8. *줄 바꿈**: 모든 단락 사이는 \n으로 처리하세요. \n 끼리는 어떤 이유에서든지 붙어있거나 중간에 공백이있게 해서 절대로 2번 쓰는일이없도록하세요. \n다음에는 무조건 문장이 올겁니다. 또한번의 \n는없습니다. \n\n은 절대 사용하지 마세요. '\n' 또는 '\n\n' 같은 문자열을 텍스트로 삽입하지 마세요.
        ---
